                        ...
                        <tr data-id="<?= $item['ID_sp'] ?>">
                            ...
                            <td>
                                <div class="qty-control">
                                    ...
                                    <input type="text" class="qty-input" value="<?= $item['So_luong'] ?>" min="1" max="<?= $item['So_luong_ton'] ?>" onchange="updatetotal(<?= $item['ID_sp'] ?>, 0)">
                                    <button class="qty-btn" onclick="updateQty(<?= $item['ID_sp'] ?>, 1)">+</button>
                                </div>
                            </td>
...
async function updatetotal(productId, newvalue) {
                    ...
                    ${cart.map(item => `
                        <tr data-id="${item.ID_sp}">
                            ...
                            <td>
                                <div class="qty-control">
                                    <button class="qty-btn" onclick="updateQty(${item.ID_sp}, -1)">−</button>
                                    <input type="text" class="qty-input" value="${item.So_luong}" min="1" onchange="updatetotal(${item.ID_sp}, this.value)">
                                    <button class="qty-btn" onclick="updateQty(${item.ID_sp}, 1)">+</button>
                                </div>
                            </td>
