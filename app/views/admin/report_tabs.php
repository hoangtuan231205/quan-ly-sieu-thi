...
$report_tabs = [
    'reports' => ['icon' => 'fas fa-chart-pie', 'label' => 'Tổng quan', 'url' => BASE_URL . '/public/admin/reports'],
    'report-profit' => ['icon' => 'fas fa-dollar-sign', 'label' => 'Doanh thu & Lợi nhuận', 'url' => BASE_URL . '/public/admin/report-profit'],
    'report-expiry' => ['icon' => 'fas fa-clock', 'label' => 'Hàng sắp hết hạn', 'url' => BASE_URL . '/public/admin/report-expiry'],
    'report-top-products' => ['icon' => 'fas fa-star', 'label' => 'SP Bán chạy', 'url' => BASE_URL . '/public/admin/report-top-products'],
];
?>
